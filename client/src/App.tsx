  ...
  return (
    <LexiAIProvider>
      <Switch>
        ...
        <Route path="/lawyer/:id" component={LawyerProfile} /> {/* Individual lawyer profile */}
        <Route path="/consultation/:id" component={Consultation} /> {/* Video/call/chat consultation */}
        <Route path="/consultations/payment-confirmation" component={ConsultationPaymentConfirmation} /> {/* Payment confirmation */}
